...
- Backend setup: [phase-4-backend-setup-guide.md](./phase-4-backend-setup-guide.md)
- Frontend integration: [phase-4-frontend-project-integration-guide.md](./phase-4-frontend-project-integration-guide.md)
