...
Connecting Discord uses a webhook-based approach. The admin creates one or more Discord webhooks and pastes them into Trussen for default, urgent, project, or team routing:
