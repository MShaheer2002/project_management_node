-- CreateEnum
CREATE TYPE "AiMessageRole" AS ENUM ('USER', 'ASSISTANT', 'TOOL_CALL', 'TOOL_RESULT');
...
-- CreateIndex
CREATE INDEX "AiConversation_userId_workspaceId_idx" ON "AiConversation"("userId", "workspaceId");
